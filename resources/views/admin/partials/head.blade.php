...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{asset('admin_assets/dist/img/AdminLTELogo.png')}}"/>
  <title>Admin</title>
  ...
  <link rel="stylesheet" href="{{ asset('admin_assets/css/content.css')}}">
...
<script src="{{ asset('admin_assets/plugins/flot-old/jquery.flot.resize.min.js')}}"></script>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<script src="{{ asset('admin_assets/plugins/flot-old/jquery.flot.pie.min.js')}}"></script>
